...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__5785){
var map__5786 = p__5785;
var map__5786__$1 = (((((!((map__5786 == null))))?(((((map__5786.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5786.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5786):map__5786);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5786__$1,cljs.core.cst$kw$on_DASH_write);
...
(jsprops.onChange = (function (p1__5788_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__5788_SHARP_);
}));
