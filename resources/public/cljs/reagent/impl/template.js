...
var G__5427 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__5427,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__5429__i = 0, G__5429__a = new Array(arguments.length -  0);
while (G__5429__i < G__5429__a.length) {G__5429__a[G__5429__i] = arguments[G__5429__i + 0]; ++G__5429__i;}
  args = new cljs.core.IndexedSeq(G__5429__a,0,null);
} 
return G__5428__delegate.call(this,args);};
G__5428.cljs$lang$maxFixedArity = 0;
G__5428.cljs$lang$applyTo = (function (arglist__5430){
...
var G__5431 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__5431,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__5432__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__5432 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__5433__i = 0, G__5433__a = new Array(arguments.length -  0);
while (G__5433__i < G__5433__a.length) {G__5433__a[G__5433__i] = arguments[G__5433__i + 0]; ++G__5433__i;}
  args = new cljs.core.IndexedSeq(G__5433__a,0,null);
} 
return G__5432__delegate.call(this,args);};
G__5432.cljs$lang$maxFixedArity = 0;
G__5432.cljs$lang$applyTo = (function (arglist__5434){
var args = cljs.core.seq(arglist__5434);
return G__5432__delegate(args);
});
...
var G__5435 = props;
var G__5435__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__5435,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__5435);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__5435__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__5436 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__5436,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__5436;
}
})(),id_class);
...
var G__5437 = (cljs.core.count.call(null,argv) - first_child);
switch (G__5437) {
case (0):
...
var vec__5439 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__5439,(0),null);
var id = cljs.core.nth.call(null,vec__5439,(1),null);
var className = cljs.core.nth.call(null,vec__5439,(2),null);
...
var temp__5808__auto___5442 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___5442 == null)){
} else {
var key_5443 = temp__5808__auto___5442;
(jsprops.key = key_5443);
}
...
var temp__5808__auto___5444 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___5444 == null)){
} else {
var key_5445 = temp__5808__auto___5444;
(jsprops.key = key_5445);
}
...
var temp__5808__auto___5446 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___5446 == null)){
} else {
var key_5447 = temp__5808__auto___5446;
(jsprops.key = key_5447);
}
...
var temp__5808__auto___5448 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___5448 == null)){
} else {
var key_5449 = temp__5808__auto___5448;
(jsprops.key = key_5449);
}
...
var temp__5808__auto___5450 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___5450 == null)){
} else {
var key_5451 = temp__5808__auto___5450;
(jsprops.key = key_5451);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__5452_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__5452_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__5453 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__5453,(0),null);
var derefed = cljs.core.nth.call(null,vec__5453,(1),null);
...
break;
default:
var G__5458 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__5459 = compiler;
v = G__5458;
compiler = G__5459;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template5463 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template5463 = (function (opts,id,fn_to_element,parse_fn,meta5464){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta5464 = meta5464;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template5463.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_5465,meta5464__$1){
var self__ = this;
var _5465__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template5463(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta5464__$1));
}));

(reagent.impl.template.t_reagent$impl$template5463.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_5465){
var self__ = this;
var _5465__$1 = this;
return self__.meta5464;
}));

(reagent.impl.template.t_reagent$impl$template5463.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template5463.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template5463.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template5463.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template5463.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template5463.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta5464","meta5464",-1862216696,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template5463.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template5463.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template5463");

(reagent.impl.template.t_reagent$impl$template5463.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write.call(null,writer__5328__auto__,"reagent.impl.template/t_reagent$impl$template5463");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template5463.
 */
reagent.impl.template.__GT_t_reagent$impl$template5463 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template5463(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta5464){
return (new reagent.impl.template.t_reagent$impl$template5463(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta5464));
});

}

return (new reagent.impl.template.t_reagent$impl$template5463(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
