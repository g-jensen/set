...
var G__5839 = o;
goog.object.set(G__5839,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__5843 = o;
goog.object.set(G__5843,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__5844__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
var G__5847 = props;
var G__5847__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5847,cljs.core.cst$kw$id,id):G__5847);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5847__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__5848 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5848,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__5848;
}
})(),id_class);
...
var G__5849 = (cljs.core.count(argv) - first_child);
switch (G__5849) {
case (0):
...
break;
case (1):
var G__5850 = component;
var G__5851 = jsprops;
var G__5852 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__5850,G__5851,G__5852);
...
var vec__5854 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5854,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5854,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5854,(2),null);
...
var temp__5808__auto___5857 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___5857 == null)){
} else {
var key_5858 = temp__5808__auto___5857;
(jsprops.key = key_5858);
}
...
var temp__5808__auto___5861 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___5861 == null)){
} else {
var key_5862 = temp__5808__auto___5861;
(jsprops.key = key_5862);
}

var G__5859 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__5860 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__5859,G__5860);
});
/**
...
var temp__5808__auto___5863 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___5863 == null)){
} else {
var key_5864 = temp__5808__auto___5863;
(jsprops.key = key_5864);
}
...
var temp__5808__auto___5865 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___5865 == null)){
} else {
var key_5866 = temp__5808__auto___5865;
(jsprops.key = key_5866);
}
...
var temp__5808__auto___5867 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___5867 == null)){
} else {
var key_5868 = temp__5808__auto___5867;
(jsprops.key = key_5868);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__5869_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__5869_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__5870 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5870,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5870,(1),null);
...
break;
default:
var G__5875 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__5876 = compiler;
v = G__5875;
compiler = G__5876;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template5880 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template5880 = (function (opts,id,fn_to_element,parse_fn,meta5881){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta5881 = meta5881;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template5880.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_5882,meta5881__$1){
var self__ = this;
var _5882__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template5880(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta5881__$1));
}));

(reagent.impl.template.t_reagent$impl$template5880.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_5882){
var self__ = this;
var _5882__$1 = this;
return self__.meta5881;
}));

(reagent.impl.template.t_reagent$impl$template5880.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template5880.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template5880.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template5880.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template5880.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template5880.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$parse_DASH_fn,cljs.core.cst$sym$meta5881], null);
}));

(reagent.impl.template.t_reagent$impl$template5880.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template5880.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template5880");

(reagent.impl.template.t_reagent$impl$template5880.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template5880");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template5880.
 */
reagent.impl.template.__GT_t_reagent$impl$template5880 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template5880(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta5881){
return (new reagent.impl.template.t_reagent$impl$template5880(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta5881));
});

}

return (new reagent.impl.template.t_reagent$impl$template5880(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
