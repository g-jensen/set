...
var G__4430 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__4430;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4431 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4431,ch);
...
if(("\\" === ch__$1)){
var ch_4432__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_4432__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_4432__$2);
} else {
}

var G__4433 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__4433;
continue;
}
}
...
var vec__4441 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4441,(0),null);
var start_column = cljs.core.nth.call(null,vec__4441,(1),null);
...
var G__4444 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4444;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__4445 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__4446 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__4446);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__4445);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__4447 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4447,(0),null);
var start_column = cljs.core.nth.call(null,vec__4447,(1),null);
...
var vec__4450 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4450,(0),null);
var end_column = cljs.core.nth.call(null,vec__4450,(1),null);
...
var vec__4453 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4453,(0),null);
var start_column = cljs.core.nth.call(null,vec__4453,(1),null);
...
var vec__4456 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4456,(0),null);
var end_column = cljs.core.nth.call(null,vec__4456,(1),null);
...
var vec__4459 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4459,(0),null);
var start_column = cljs.core.nth.call(null,vec__4459,(1),null);
...
var vec__4462 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4462,(0),null);
var end_column = cljs.core.nth.call(null,vec__4462,(1),null);
...
var sb = (function (){var G__4465 = (new goog.string.StringBuffer());
G__4465.append(initch);
...
var G__4467 = (function (){var G__4466 = sb;
G__4466.append(ch);

return G__4466;
})();
var G__4468 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__4467;
ch = G__4468;
continue;
}
...
switch (G__4471) {
case "\\":
var G__4475 = (function (){var G__4472 = sb;
G__4472.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__4472;
})();
var G__4476 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4475;
ch = G__4476;
continue;
...
break;
default:
var G__4477 = (function (){var G__4473 = sb;
G__4473.append(ch);

return G__4473;
})();
var G__4478 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4477;
ch = G__4478;
continue;
...
var vec__4479 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4479,(0),null);
var end_column = cljs.core.nth.call(null,vec__4479,(1),null);
...
var vec__4482 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4482,(0),null);
var column = cljs.core.nth.call(null,vec__4482,(1),null);
...
var vec__4487 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4487,(0),null);
var column = cljs.core.nth.call(null,vec__4487,(1),null);
...
var vec__4492 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4492,(0),null);
var column = cljs.core.nth.call(null,vec__4492,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__4497 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4497,(0),null);
var start_column = cljs.core.nth.call(null,vec__4497,(1),null);
...
var vec__4500 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4500,(0),null);
var end_column = cljs.core.nth.call(null,vec__4500,(1),null);
...
var G__4503 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4503,true,null,opts,pending_forms);
...
var G__4504 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4504)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4504)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4504)){
...
var _STAR_suppress_read_STAR__orig_val__4505 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4506 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4506);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4505);
}});
...
var G__4507 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__4507,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__4507,rdr,first_line);
...
var G__4511 = matched;
var G__4512 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__4511;
finished = G__4512;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__4513 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4514 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4514);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4513);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__4515 = cljs.tools.reader.arg_env;
var arg_env_temp_val__4516 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__4516);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__4517 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4517,"(");
...
var G__4518 = (i + (1));
var G__4519 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__4515);
}});
/**
...
var ch = temp__5802__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__4520 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__4520);
...
var G__4521 = cljs.core.next.call(null,s__$1);
var G__4522 = ret;
s__$1 = G__4521;
r = G__4522;
continue;
...
var G__4523 = cljs.core.next.call(null,s);
var G__4524 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__4523;
key_vals = G__4524;
continue;
} else {
...
var gensym_env_orig_val__4529 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__4530 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__4530);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__4529);
}});
...
var temp__5802__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__4531 = token;
var G__4531__$1 = (((G__4531 == null))?null:cljs.core.subs.call(null,G__4531,(1)));
var G__4531__$2 = (((G__4531__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4531__$1));
var G__4531__$3 = (((G__4531__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4531__$2));
var G__4531__$4 = (((G__4531__$3 == null))?null:cljs.core.symbol.call(null,G__4531__$3));
if((G__4531__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__4531__$4);
}
})():(function (){var G__4532 = token;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__4543,reader){
...
var opts = map__4544__$1;
var eof = cljs.core.get.call(null,map__4544__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
